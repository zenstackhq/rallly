...
test.describe('House-keeping API', () => {
    ...
    test('should mark inactive polls as deleted except for polls in spaces with active subscriptions', async ({
        ...
        const deletedPollFromFreeUser = await db.poll.findUnique({
        ...
        const deletedPollNoUser = await db.poll.findUnique({
        ...
        const protectedPollInPaidSpace = await db.poll.findUnique({
        ...
        const protectedRecentPoll = await db.poll.findUnique({
        ...
        const protectedPollWithFutureOptions = await db.poll.findUnique({
        ...
        const protectedPollWithRecentViews = await db.poll.findUnique({
    ...
    test('should permanently remove polls that have been marked as deleted for more than 7 days', async ({
        ...
        const oldDeletedPoll = await db.poll.create({
            data: {
                id: 'old-deleted-poll',
        ...
        const recentDeletedPoll = await db.poll.create({
            data: {
